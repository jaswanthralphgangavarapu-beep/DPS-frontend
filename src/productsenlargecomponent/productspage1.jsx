                ...
                <div className="tuple_nation_size_chart_dropdown">
                  <table className="tuple_nation_size_table">
                    ...
                    <tbody>
                      ...
                      <tr><td>XL</td><td>44"</td><td>44"</td><td>18"</td></tr>
              ...
              <div key={i} style={{ display: 'flex', gap: '12px', padding: '16px 0', borderBottom: '1px solid #eee' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '8px' }}>
                    <button onClick={() => updateQty(i, -1)} style={{ width: '32px', height: '32px', border: '1px solid #ddd', background: '#fff' }}>-</button>
                    <span style={{ fontWeight: 'bold' }}>{item.qty}</span>
                    <button onClick={() => updateQty(i, 1)} style={{ width: '32px', height: '32px', border: '1px solid #ddd', background: '#fff' }}>+</button>
                    <span style={{ marginLeft: 'auto', fontWeight: 'bold' }}>₹{(item.price * item.qty).toLocaleString()}</span>
                  </div>
                </div>
                <button onClick={() => removeFromBag(i)} style={{ color: '#ff4d4f', background: 'none', border: 'none' }}>Remove</button>
              </div>
            ))}
